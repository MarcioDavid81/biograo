...
export default async function ProductPage({ params }: ProductPageProps) {
  ...
  return (
    <div className='flex flex-col items-center w-[90%] mx-auto space-y-4 my-6'>
        <Image src={product.acf.thumbnail} alt={product.acf.name} width={300} height={300} />
        ...
        <div>
            ...
            <span className='bg-lime-200'>em até 12x de {priceFormat(product.acf.price / 12)}</span>
